...
const TEXT = {
  ko: {
    ...
    navProjects: '프로젝트', navReviews: '리뷰', navLibrary: '자료',
    tasks: '오늘 할 일',
    noTasks: '체크박스가 없습니다',
    openDevlog: '개발일지 열기',
    makeDevlog: '개발일지 만들기',
    ...
    libraryTitle: '자료', libraryHelp: 'AI가 정리한 영상과 저장한 웹 링크를 분야와 용도별로 찾습니다.',
    libraryYoutubeTitle: 'YouTube 정리', libraryYoutubeEmpty: '아직 AI로 정리한 영상이 없습니다',
    libraryWebTitle: '저장한 링크', libraryWebEmpty: '아직 저장한 웹 링크가 없습니다',
    linkUntitled: '제목 없는 링크', linkSaved: '저장됨', libraryAll: '전체', libraryTypeFilter: '링크 형태', libraryAreaFilter: '개발 분야', libraryOpenIndex: '링크 자료실 열기', libraryOpenYoutube: '유튜브 자료실 열기', libraryOpenArea: (area) => `${area} 링크 열기`, libraryIndexPending: '첫 링크를 저장하면 자료실이 생깁니다',
    libraryTypes: { docs: '문서', tool: '도구', inspiration: '영감', asset: '에셋', article: '글', reference: '참고' },
    libraryAreas: { frontend: '프론트엔드', backend: '백엔드', infra: '인프라·DevOps', 'data-ai': '데이터·AI', design: '디자인', common: '공통', uncategorized: '미분류', dev: '개발 일반', ai: 'AI' },
  ...
  en: {
    ...
    navProjects: 'Projects', navReviews: 'Reviews', navLibrary: 'Library',
    tasks: "Today's tasks",
    ...
    libraryTitle: 'Library', libraryHelp: 'Find AI-organized videos and saved web links by area and purpose.',
    libraryYoutubeTitle: 'YouTube summaries', libraryYoutubeEmpty: 'No AI-organized videos yet',
    libraryWebTitle: 'Saved links', libraryWebEmpty: 'No saved web links yet',
    linkUntitled: 'Untitled link', linkSaved: 'Saved', libraryAll: 'All', libraryTypeFilter: 'Link type', libraryAreaFilter: 'Development area', libraryOpenIndex: 'Open link library', libraryOpenYoutube: 'Open YouTube library', libraryOpenArea: (area) => `Open ${area} links`, libraryIndexPending: 'Save your first link to create the library',
    libraryTypes: { docs: 'Docs', tool: 'Tools', inspiration: 'Inspiration', asset: 'Assets', article: 'Articles', reference: 'Reference' },
    libraryAreas: { frontend: 'Frontend', backend: 'Backend', infra: 'Infra and DevOps', 'data-ai': 'Data and AI', design: 'Design', common: 'Common', uncategorized: 'Uncategorized', dev: 'General development', ai: 'AI' },
