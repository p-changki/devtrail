...
const target = `${folder}/${iso} 주간리뷰.md`;
...
await tp.file.move(`${folder}/${iso} 주간리뷰`);
...
const P = { root: DT.root || "", devlog: dtPath("devlog"), inbox: dtPath("inbox"), repodocs: dtPath("repodocs") };
-%>
---
tags:
  - type/weekly-review
